...
class CSV:
    ...
    def get_transactions(cls, start_date, end_date):
        ...
        if filtered_df.empty:
            ...
            print (f"Transactinos from {start_date.strftime(CSV.FORMAT)} to {end_date.strftime(CSV.FORMAT)}")
...
def add():
    CSV.initialize_csv()
    date = get_date(
        "Enter the date of the transaction in dd-mm-yyyy or press enter for default it to today's date", allow_default=True,
    )
    amount = get_amount()
